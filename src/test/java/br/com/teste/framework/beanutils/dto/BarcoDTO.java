...
public class BarcoDTO {
	...
	private List<PassageiroDTO> listaPassageiro;
	public BarcoDTO() {
		super();
	}
	public BarcoDTO(Integer id, String nome, double capacidade, List<PassageiroDTO> listaPassageiro) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public List<PassageiroDTO> getListaPassageiro() {
		return listaPassageiro;
	}
	public void setListaPassageiro(List<PassageiroDTO> listaPassageiro) {
		this.listaPassageiro = listaPassageiro;
	}
	@Override
